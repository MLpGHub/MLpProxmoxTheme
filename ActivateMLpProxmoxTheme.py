...
def installTheme():
    clear()
    doHeader()
    baseURL = os.getenv('BASEURL', 'https://github.com/MLpGHub/MLpProxmoxTheme/raw/' + os.getenv("BRANCH", "master"))
    ...
    urllib.request.urlretrieve(baseURL + '/MLpProxmoxTheme/sass/MLpProxmoxTheme.css', '/usr/share/pve-manager/css/dd_style.css')
    cprint(colors.NORMAL, 'Downloading patcher..')
    urllib.request.urlretrieve(baseURL + '/MLpProxmoxTheme/js/MLpProxmoxTheme.js', '/usr/share/pve-manager/js/dd_patcher.js')
    ...
    for index, image in enumerate(images):
        ...
        urllib.request.urlretrieve(baseURL + '/MLpProxmoxTheme/images/' + image, '/usr/share/pve-manager/images/' + image)
